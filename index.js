...
// A. the variable external is on the global scope which allows the nested function to access it, but the opposite could not occur because a variable within the funciton would be scoped to that function.
...
const zooAnimals = [
  ...
  */
  function USApop(data){
    const popData = data.reduce(function(accum, item){
